...
<h3 align="center">
    Os códigos deste projeto tem como função executar o cálculo da tripla pitagórica de forma serial e de forma paralela nas linguagens C++ e Python a fim de demonstrar se existe diferença de desempenho entre os códigos seriais e paralelos em cada linguagem. Para o paralelismo em C++ foi utilizado o OpenMP e para o cálculo do paralelismo em Python também utilizou-se do código em C++ que foi importado através da biblioteca ctypes para o Python. 
</h3>
